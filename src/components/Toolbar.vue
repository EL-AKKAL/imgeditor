...
<template>
  <div class="flex justify-between items-center">
    <button class="cursor-pointer" @click="store.resetFilters" :disabled="!store.editedImage">
      Reset Filters
    </button>
    <div class="flex gap-4 items-center">
      <input ref="fileInput" type="file" @change="handleImageUpload" accept="image/*" hidden />
      <button class="cursor-pointer" @click="fileInput?.click()">Choose Image</button>
      <button
